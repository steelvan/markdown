...
Вложенные списки создаются отступом более трех символов или табуляцией и *

* Верхний элемент 1
    * Вложенныей элемент 1.1
    * Вложенныей элемент 2.1
* Верхний элемент 2
    * Вложенныей элемент 2.1
    * Вложенныей элемент 2.2
...
Тот же код можно записать так:

Markdown | не такой | красивый
--- | --- | ---
*Но выводится* | `так же` | **здорово**
1 | 2 | 3
```
...
##### <a name="Зачеркивания"></a> Зачеркивания
```no-highlight
